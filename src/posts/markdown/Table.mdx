...
title: Table
category: Markdown
description: 문서에 간단한 서식 기능이 제공되는 표를 추가할 수 있다.
...
|---|---|---|---|
|*기울임*|**굵게**|~~취소선~~|<u>밑줄</u>|
|<span style={{textDecoration: "underline"}}>밑줄 2</span>|<span style={{color:"blue"}}>색상 추가</span>|<span style={{color:"blue"}}>*색상 추가, 기울임*</span>|<span style={{textDecoration:"underline",color:"red"}}>밑줄, 색상 추가</span>|
|[`내부 링크`](#1-introduction)|[일반 링크](https://google.com)|[참조링크][1]|**[링크 강조](https://google.com)**|
...
- 아래는 마크다운 테이블 생성 사이트이다.
    1. [Tables Generator](https://www.tablesgenerator.com/markdown_tables)
    2. [TableConvert](https://tableconvert.com/markdown-generator)
...
- [Emphasis](/posts/markdown/emphasis)