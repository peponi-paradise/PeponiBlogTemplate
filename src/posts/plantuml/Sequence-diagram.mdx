...
category: PlantUML
description: Sequence diagram은 객체간의 상호작용을 순서에 따라 표현할 수 있다.
date: 2024-10-08T00:00:00+09:00
tags: ["Syntax", "UML", "Sequence diagram"]
---
...
3. <span style={{color:'#DC143C'}}>VSCode에서 Markdown으로 PlantUML 작성 후 HTML 뽑아낼 시 첫 페이지를 제외한 다음 페이지들 정상 출력이 불가
...
- [Sequence](https://plantuml.com/ko/sequence-diagram)